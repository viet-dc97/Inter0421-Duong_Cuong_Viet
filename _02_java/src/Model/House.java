...
public class House extends Services {
    ...
    public House(String id, String serviceName, double acreage, double rentalCost, int maxNumOfPeople, String rentalType, String roomType, String description, int floors) {
